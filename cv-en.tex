...
%	\end{Itemize}
	...
	\begin{tabular}{m{4.5cm} m{13cm}}\renewcommand{\arraystretch}{2}
		\textbf{Networking}   			& Cisco IOS, Open vSwitch, RouterOS, ArubaOS, OpenFlow, SDN programming.\\
		\textbf{Security}				& pfSense, PKI, OpenVPN, ACLs/Firewalls \\
		\textbf{System Administration}	& Unix, NGINX, Windows Server, LDAP. \\
		\textbf{Virtualization}			& Proxmox VE, Docker, XCP-ng.\\ 
		\textbf{Programming} 	    	& Python, JavaScript, Django, Java, MATLAB, C/C++. \\
		\textbf{Telecommunications}   	& ITU-T PONs, Simulation (OmNET++). \\
